          ...
          <div>
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 transition-colors">
                  Subscribe
                </button>
              </div>
            </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-gray-400 text-sm flex items-center gap-2">
              Made with <Heart size={16} className="text-pink-500 fill-pink-500" /> using React & Motion
            </p>
          </div>
        </motion.div>
      </div>
