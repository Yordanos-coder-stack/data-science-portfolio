...
const expertise = [
  {
    ...
    description:
      "Building predictive models using scikit-learn, TensorFlow, and PyTorch to solve real-world problems.",
  ...
  },
  {
    ...
    description:
      "Designing and optimizing data pipelines using SQL, Spark, and modern cloud-based tools.",
  ...
  },
  {
    ...
    description:
      "Creating interactive dashboards and visual insights using Power BI, Tableau, and Python libraries.",
  ...
  },
  {
    ...
    description:
      "Applying statistical methods and experimental design to extract meaningful insights from data.",
          ...
          {expertise.map((item, index) => (
            ...
            >
              <Card className="p-6 h-full hover:shadow-xl transition-shadow duration-300 border-2 hover:border-purple-200 group cursor-pointer">
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-lg bg-gradient-to-br ${item.color} flex items-center justify-center mb-4 group-hover:shadow-lg transition-shadow`}
                  >
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                My journey into data science began during my academic studies,
                where I discovered how statistics and machine learning can be used
                to solve meaningful real-world problems. Since then, I have worked
                on multiple projects involving data analysis, predictive modeling,
                and visualization.
              </p>

              <p className="text-gray-700 leading-relaxed">
                I am continuously improving my skills in machine learning and data
                engineering while staying updated with modern AI tools and techniques.
                I enjoy working with datasets, building dashboards, and learning from
